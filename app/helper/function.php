    ...
    foreach ($mang as $value) {
        ...
        if ($value['parent'] == $parent) {
            ...
            <div class="category-fix">
                <a class="btn-category btn-primary" href="/admin/category/edit/' . $value['id'] . '"><i
                        class="fa fa-edit"></i></a>
                <a onclick="return delCate()" class="btn-category btn-danger" href="/admin/category/del/' . $value['id'] . '"><i
