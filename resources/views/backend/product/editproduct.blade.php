                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="featured" class="form-control">
                                                <option @if ($product->featured==0){{ 'selected' }} @endif
                                                    value="0">Không
                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required name="product_state" class="form-control">
                                                <option @if ($product->state==0){{ 'selected' }} @endif value="1">Còn
                                                    hàng
                                                </option>
                                                <option @if ($product->state==0){{ 'selected' }} @endif value="0">Hết
                                                    hàng
                                                </option>
                                            </select>
                                        </div>
                                            ...
                                            <div class="tab-pane fade  @if($i==1) active @endif in"
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            @foreach ($attr->values as $value)
                                                            <td> <input @if (check_value($product,$value->id))
                                                                checked
